...
![Build Status](http://jenkins.eaglegenomics.com:8080/job/Chef%20Bowtie/1/badge/icon)
![Build Status](http://jenkins.eaglegenomics.com:8080/buildStatus/icon?job=Chef Bowtie&build=1)
